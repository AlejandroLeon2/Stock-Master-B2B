...
import { LucideAngularModule, LayoutDashboard, ShoppingCart, Users, Package, LogOut, Settings, FileText } from 'lucide-angular';
    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col h-full">
      ...
      <nav class="flex-1 overflow-y-auto py-6 px-3 space-y-6">
        ...
        <div class="space-y-1">
          ...
          <a routerLink="/admin/catalog" routerLinkActive="bg-blue-50 text-blue-600" class="flex items-center gap-3 px-3 py-2 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 transition-colors">
             <lucide-icon [img]="PackageIcon" class="w-5 h-5" />
             Catálogo
          </a>

           <a routerLink="/admin/warehouse" routerLinkActive="bg-blue-50 text-blue-600" class="flex items-center gap-3 px-3 py-2 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-50 hover:text-gray-900 transition-colors">
             <lucide-icon [img]="PackageIcon" class="w-5 h-5" />
             Almacén
          </a>
        </div>
      ...
      <div class="p-4 border-t border-gray-200">
        <button class="w-full flex items-center gap-3 px-3 py-2 text-sm font-medium text-red-600 rounded-lg hover:bg-red-50 transition-colors">
